    ...
    return ClipRRect(
      ...
      child: GridTile(
        ...
        footer: GridTileBar(
          ...
          // Consumer is the same as Provider.of<Product>(context);
          // Consumer's advantage is that with it, it is possible to rebuild only the part of the widget that actually changes
